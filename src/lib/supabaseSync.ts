...
const toDbSettings = (settings: UserSettings, firstName: string, userId: string) => ({
  ...
  overtime_payout_month: settings.overtime_payout_month ?? "current",
  fixed_components: settings.fixed_components ?? [],
  fixed_components_in_gross: settings.fixed_components_in_gross ?? true,
  ...
  vacation_negative_limit: settings.vacation_negative_limit ?? null,
  sick_negative_limit: settings.sick_negative_limit ?? null,
...
const fromDbSettings = (row: any): { settings: UserSettings; firstName: string } => ({
  ...
  settings: {
    ...
    overtime_payout_month: row.overtime_payout_month,
    fixed_components: row.fixed_components ?? [],
    fixed_components_in_gross: row.fixed_components_in_gross ?? true,
    ...
    vacation_negative_limit: row.vacation_negative_limit != null ? Number(row.vacation_negative_limit) : undefined,
    sick_negative_limit: row.sick_negative_limit != null ? Number(row.sick_negative_limit) : undefined,
